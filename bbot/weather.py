...
WEATHER_SERVICE_API_KEY = os.getenv('54816b87b8ae2ac5a85a3175b3b992ab')
...
def get_city_query_url(city_name: str):
    return f'http://api.openweathermap.org/data/2.5/weather?q={urllib.parse.quote(city_name)}&appid=54816b87b8ae2ac5a85a3175b3b992ab&lang=ru'


def get_location_query_url(location: Location):
    return f'http://api.openweathermap.org/data/2.5/weather?lat={location.latitude}&lon={location.longitude}&appid=54816b87b8ae2ac5a85a3175b3b992ab&lang=ru'
